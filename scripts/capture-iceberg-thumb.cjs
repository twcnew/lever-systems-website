...
const OUT_PNG = join(ROOT, "public", "studio", "iceberg.png");
const RAW_PNG = join(ROOT, "exports", "_iceberg-thumb-raw.png");
const PAGE_URL = process.env.ICEBERG_URL ?? "http://localhost:3001/studio/iceberg/";
const WIDTH = Number(process.env.ICEBERG_WIDTH) || 720;
