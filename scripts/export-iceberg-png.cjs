...
const OUT = join(ROOT, "exports", "iceberg-linkedin.png");
const URL = process.env.ICEBERG_URL ?? "http://localhost:3001/studio/iceberg/";
const WIDTH = Number(process.env.ICEBERG_WIDTH) || 880;
